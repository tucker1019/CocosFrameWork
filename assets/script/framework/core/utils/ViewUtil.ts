...
import { Animation, AnimationClip, EventTouch, instantiate, isValid, Node, Prefab, Size, UITransform, v3, Vec3 } from "cc";
...
export class ViewUtil {
     ...
     */
    public static  findNodes(reg: RegExp, parent: Node, nodes?: Array<Node>): Array<Node> {
     ...
     * @param path 资源路径
     */
    public static  createPrefabNode(path: string): Node {
     ...
     */
    public static  addNodeAnimation(path: string, node: Node, onlyOne: boolean = true, isDefaultClip: boolean = false) {
